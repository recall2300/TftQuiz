...
function LoginContent() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center bg-background p-4">
      <Card className="w-full max-w-sm border-border bg-white shadow-lg">
        <CardHeader className="text-center">
          <div className="mx-auto mb-3 flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-50 border-2 tft-border-gold">
        ...
        <CardContent className="space-y-4">
          ...
          <Button
            ...
            className="w-full gap-2 bg-white text-gray-700 border border-gray-200 hover:bg-gray-50 shadow-sm"
            size="lg"
          >
